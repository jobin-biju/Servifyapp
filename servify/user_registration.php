...
if (isset($_POST['submit'])) {
    ...
    if ($password !== $confirm_password) {
        ...
        $sql = "INSERT INTO user_registration (name, email, phonenumber, address, pincode, district, place, gender, type) 
                VALUES ('$name', '$email', '$phonenumber', '$address', '$pincode', '$district', '$place', '$gender', 'user')";
